                ...
                Fragment
{
    ...
    // TODO: Refactor and set to constants
    // ===================================
    public Bundle getFragmentData() {
        ...
        if(fragmentTitle != null || fragmentContent != null) {
            ...
            fragmentData.putString("BACK_CARD_TITLE", fragmentTitle.getHint().toString());
        }
        else {
            fragmentData.putString("BACK_CARD_TITLE", fragmentTitle.getText().toString());
        }

        fragmentData.putString("BACK_CARD_CONTENT", fragmentContent.getFormattedText());
