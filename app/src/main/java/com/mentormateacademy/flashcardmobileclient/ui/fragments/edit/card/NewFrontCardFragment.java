    ...
    public Bundle getFragmentData() {
        ...
        if(fragmentTitle != null || fragmentContent != null) {
            ...
            if(fragmentTitle.getText().toString().isEmpty()) {
                fragmentData.putString("FRONT_CARD_TITLE", fragmentTitle.getHint().toString());
            }
            else {
                fragmentData.putString("FRONT_CARD_TITLE", fragmentTitle.getText().toString());
            }

            fragmentData.putString("FRONT_CARD_CONTENT",
