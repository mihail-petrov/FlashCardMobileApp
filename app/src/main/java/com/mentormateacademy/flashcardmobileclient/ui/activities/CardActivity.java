...
import com.mentormateacademy.flashcardmobileclient.ui.fragments.example_nested_fragment.ExperimentalSingleShowCardFragment;
            ...
            EditCardViewFragment.fragmentActionCallback
{
    ...
    public void initFragment(){
        setFragment(ExperimentalSingleShowCardFragment.newInstance(), false);
    }
        ...
        if(item.getItemId() == R.id.delete_card) {
            ...
            alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    //Card cardElement = DatabaseRepository.getRepository(CardActivity.this).getCardRepository().readBy(bundle).get(0);
